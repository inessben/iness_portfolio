...
gltfLoader.load(
    ...
    (gltf) => {
        avatar = gltf.scene
        avatar.position.y = -9.5
        // avatar.rotation.y = - Math.PI * 1
        // avatar.position.z = -5
...
const rectAreaLight = new THREE.RectAreaLight(0xFFFFFF, 2, 10, 20)
...
const ambientLight = new THREE.AmbientLight(0xAD41FF, 0.9)
scene.add(ambientLight)

// Add a white ambient light
const whiteAmbientLight = new THREE.AmbientLight(0xFFFFFF, 0.4)
scene.add(whiteAmbientLight)

// // add a grey directionnal light
const directionalLight = new THREE.DirectionalLight(0xED8FB6, 1.5)
