...
// // // Add some texts
// Variable pour garder une référence du texte affiché actuellement
...
// Fonction pour afficher le texte spécifié
...
// loader.load('./assets/fonts/press_start2_regular.json',
//     (font) => {
//         const cityGeometry = new TextGeometry("I live in Paris where I'm studying digital, \npassionate about UI design and front-end development.", {
//             font: font,
//             size: 0.5,
//             height: 0.1,
//         })
//         const cityMaterial = new THREE.MeshBasicMaterial({ color: 0xe5e5e5 })
...
// loader.load('./assets/fonts/press_start2_regular.json',
//     (font) => {
//         const passionGeometry = new TextGeometry("I love anything to do with art, \nsuch as fashion, photography and decoration.", {
//             font: font,
//             size: 0.5,
//             height: 0.1,
//         })
//         const passionMaterial = new THREE.MeshPhongMaterial({ color: 0xe5e5e5 })
//         const passionMesh = new THREE.Mesh(passionGeometry, passionMaterial)
//         passionMesh.position.x = 4
//         passionMesh.position.y = -5
//         passionMesh.position.z = -18
//         passionMesh.rotation.y = - Math.PI * 0.5
...
// loader.load('./assets/fonts/press_start2_regular.json',
//     (font) => {
//         const moreGeometry = new TextGeometry("And I keep myself up to date with the latest trends, \nas this stimulates my curiosity.", {
//             font: font,
//             size: 0.5,
//             height: 0.1,
//         })
...
//         moreMesh.position.x = 3
//         moreMesh.position.y = -1
//         moreMesh.position.z = -18
//         moreMesh.rotation.y = - Math.PI * 0.5
//         scene.add(moreMesh)
//     })
...
// loader.load('./assets/fonts/press_start2_regular.json',
//     (font) => {
//         const personalityGeometry = new TextGeometry("I'm a hard-working person with a thirst for learning, \norganized and rigorous, for me, every details counts.", {
//             font: font,
//             size: 0.5,
//             height: 0.1,
//         })
//         const personalityMaterial = new THREE.MeshPhongMaterial({ color: 0xffffff })
//         const personalityMesh = new THREE.Mesh(personalityGeometry, personalityMaterial)
//         personalityMesh.position.x = 8
//         personalityMesh.position.y = -5
//         personalityMesh.position.z = -22.5
//         personalityMesh.rotation.y = - Math.PI * 0.5
