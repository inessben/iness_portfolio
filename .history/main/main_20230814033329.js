...
const loop = () => {
    ...
    for (let i = 0; i < count; i++) {
        ...
        const newX = y + Math.sin(Date.now() * 0.001 + x * 3 + z * 3) * 0.004
        const newY = x + Math.sin(Date.now() * 0.001 + x * 3 + z * 3) * 0.004
        particlesGeometry.attributes.position.array[iStride + 1] = newX
