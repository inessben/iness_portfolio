...
// 
// city
const geometry = new TextGeometry("I live in Paris where I'm studying digital, passionate about UI design and front-end development.", {
    font: font,
    size: 0.08,
    height: 0.01,
})
...
// 
// passions
const geometry = new TextGeometry("I love anything to do with art, such as fashion, photography and decoration.", {
    font: font,
    size: 0.08,
    height: 0.01,
})
...
// 
// more
const geometry = new TextGeometry("And I keep myself up to date with the latest trends and technologies, as this stimulates my curiosity.", {
    font: font,
    size: 0.08,
    height: 0.01,
})
...
// 
// personnality
const geometry = new TextGeometry("I'm a hard-working person with a thirst for learning, organized and rigorous, because for me, every details counts.", {
    font: font,
    size: 0.08,
    height: 0.01,
})
