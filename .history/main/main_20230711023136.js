...
gltfLoader.load
    (
        ...
        (gltf) => {
            ...
            bubbleSpeech.scale.set(8, 8, 8)
            bubbleSpeech.position.x = 10
            bubbleSpeech.position.y = -1
            bubbleSpeech.position.z = -7
...
function handleSpacebar(event) {
    if (event.code === 'Space') {
        ...
        const position = new THREE.Vector3(7, -8, -18)
...
const initialPosition = new THREE.Vector3(7, -8, -18)
