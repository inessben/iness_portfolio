...
function showNumberText() {
    var numberIcon = document.querySelector('.icon.number');
    var numberText = "+33648112836";
    numberIcon.setAttribute('data-text', numberText);
}
showNumberText()
...
// Add the camera
const camera = new THREE.PerspectiveCamera(32, sizes.width / sizes.height)
...
const loop = () => {
    ...
    for (let i = 0; i < count; i++) {
        ...
        const newY = y + Math.sin(Date.now() * 0.001 + x * 3 + z * 3) * 0.006
